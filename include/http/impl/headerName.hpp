#ifndef _HTTP_IMPL_HEADERNAME_HPP_
#define _HTTP_IMPL_HEADERNAME_HPP_
...
namespace http { namespace impl { namespace hn
{
...
#define HTTP_HN_INSTANCE(id_, ...)																			\
namespace http { namespace hn {																				\
	struct id_##_type																						\
	{																										\
		typedef http::impl::hn::vector2str< boost::mpl::vector_c<char, __VA_ARGS__> >::cts cts;				\
		typedef http::impl::hn::vector2str< boost::mpl::vector_c<char, __VA_ARGS__> >::ctslc ctslc;			\
		static const std::size_t size = boost::mpl::size< ctslc >::value;									\
		static const std::size_t key = http::impl::hn::hash_string< ctslc >::value;							\
		...
		static const std::string &str()																		\
		{																									\
			return http::impl::hn::stringHolder<id_##_type>::str;											\
		}																									\
		static const std::string &strlc()																	\
		{																									\
			return http::impl::hn::stringHolder<id_##_type>::strlc;											\
		}																									\
	};																										\
	namespace																								\
	{																										\

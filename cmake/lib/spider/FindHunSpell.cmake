...
SET(HUNSPELL_NAMES ${HUNSPELL_NAMES} hunspell hunspell-1.2 hunspell-1.3 libhunspell libhunspell-1.2 libhunspell-1.3)
...
ELSE(HUNSPELL_FOUND)
  MESSAGE(FATAL_ERROR "Could not find HunSpell library (inc: ${HUNSPELL_INCLUDE_DIR}, lib:${HUNSPELL_LIBRARIES})")
